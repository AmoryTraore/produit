...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('produit::pages.backoffice.categorie.index', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $categorie->save();
        return redirect()->route('categorie_liste');
    }
    ...
    public function edit($id)
    {
        ...
        return view('produit::pages.backoffice.categorie.edit', compact('categorie'));
    }
